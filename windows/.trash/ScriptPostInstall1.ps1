...
# Cambiar el calor de una clave del registro de Windows
...
function getServices {
  Get-WmiObject win32_service | Select Name, DisplayName, State, StartMode | Sort State, StartMode, Name | Format-Table -AutoSize
}
